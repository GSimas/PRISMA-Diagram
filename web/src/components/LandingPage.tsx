...
import { ArrowRight, CheckCircle2, Database, FileDown, Languages, LockKeyhole, Network, ScanSearch, ShieldCheck } from 'lucide-react';
...
export function LandingPage() {
  ...
  return (
    <main id="main-content" className="landing-page">
      ...
      <section className="model-section"><header><p className="kicker">SELEÇÃO AUTOMÁTICA</p><h2>Um modelo para cada estrutura de busca.</h2></header><div>{['Nova · bases e registros', 'Nova · todas as fontes', 'Atualizada · bases e registros', 'Atualizada · todas as fontes'].map((model, index) => <article key={model}><span>0{index + 1}</span><h3>{model}</h3><p>A estrutura metodológica permanece protegida; a apresentação pode ser ajustada sem mudar seu significado.</p><CheckCircle2 size={18} /></article>)}</div><a className="primary-button" href="/guidelines">Usar o seletor de diretriz <ArrowRight size={16} /></a></section>
